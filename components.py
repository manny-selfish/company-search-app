...
def display_initial_ai_message():
    ...
    with st.chat_message("assistant"):
        ...
        st.markdown(
            """
            <div class="assistant-note-box">
                <p>具体的に入力した方が期待通りの回答を得やすいです。</p>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div class="sidebar-info-box">
                <p><strong>【「社内文書検索」を選択した場合】</strong><br/>入力内容と関連性が高い社内文書のありかを検索できます。</p>
                <div class="example">【入力例】\n社員の育成方針に関するMTGの議事録</div>
                <p><strong>【「社内問い合わせ」を選択した場合】</strong><br/>質問・要望に対して、社内文書の情報をもとに回答を得られます。</p>
